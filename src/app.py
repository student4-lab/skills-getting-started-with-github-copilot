...
activities = {
    ...
    "Soccer Club": {
        "description": "Team soccer practice, drills, and friendly matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Basketball training, teamwork, and school league games",
    ...
    "Debate Team": {
        "description": "Practice public speaking and structured academic debates",
...
def signup_for_activity(
    activity_name: str,
    email: str = Query(..., min_length=3, pattern=r"^[^@\s]+@[^@\s]+\.[^@\s]+$")
):
    ...
    # Validate activity still has space
